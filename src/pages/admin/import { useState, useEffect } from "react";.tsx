...
export const ManageBookings = () => {
  ...
  const handleBookingSave = async () => {
    ...
    try {
      ...
      if (editBookingStartInput) updates.start_time = inputDateTimeLocalToISO(editBookingStartInput);
      if (editBookingEndInput) updates.end_time = inputDateTimeLocalToISO(editBookingEndInput);
      if (editMembershipStartInput) updates.membership_start_date = inputDateToISO(editMembershipStartInput);
      if (editMembershipEndInput) updates.membership_end_date = inputDateToISO(editMembershipEndInput);
